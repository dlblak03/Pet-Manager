  ...
  pets: {
    Tables: {
      activity_feed: {
        ...
        Relationships: [
          {
            foreignKeyName: "activity_feed_appointment_id_fkey"
          ...
          {
            foreignKeyName: "activity_feed_medical_record_id_fkey"
          ...
          {
            foreignKeyName: "activity_feed_pet_id_fkey"
            columns: ["pet_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "activity_feed_vaccination_id_fkey"
      ...
      pets: {
        ...
        Relationships: [
          {
            foreignKeyName: "pets_pet_profile_photo_fkey"
            columns: ["pet_profile_photo"]
            isOneToOne: false
