...
<svelte:head>
	...
	<meta
		name="description"
		content="Sign in to your Pet Manager account to access your pet's health records, track appointments, and manage all your furry friend's needs in one place. Secure login for pet parents."
	/>
</svelte:head>
