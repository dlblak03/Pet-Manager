...
<svelte:head>
	<title>Pet Manager | Welcome</title>
	<meta
		name="description"
		content="Sign in link sent to your email. Click the link within 1 hour to access Pet Manager and manage your pet's health records, appointments, and daily care."
	/>
</svelte:head>
		...
		<div class="flex flex-col gap-6">
			...
			<div class="flex flex-col gap-6">
				...
				<div class="flex flex-col items-center gap-2">
					...
					<div class="text-center text-base text-balance text-primary dark:text-foreground">
						{email}
					</div>
				</div>
				...
				>
					Didn't receive the email? Check your spam folder or <a href="/sign-in"
